...
<!--                                     <li><a href="https://styleci.io/">StyleCI</a></li>
                        ...
                        <div class="nav_col">
                            ...
                            <div class="footer_nav_contain">
                                <ul>
                                    <li><a href="https://www.millionsllp.com">Hive Automation</a></li>
                                     </ul>
                            </div>
                        </div>
                        <div class="nav_col">
...
{{--                                    <li><a href="/docs/{{DEFAULT_VERSION}}/telescope">Telescope</a></li>--}}
                    ...
                    <div class="footer_info">
                        <p class="small">MS-Framework is a web application framework with expressive, elegant syntax. We believe development must be an enjoyable and creative experience to be truly fulfilling. MS-Framework attempts to take the pain out of development by easing common tasks used in most web projects.</p>
                        <p class="small copyright">MS-Framework is a Trademark of Mitul Patel.<br>Copyright &copy; 2017-{{now()->format('Y')}} Million Solutions LLP.
                        </p>
                    </div>
                </div>
            </div>
